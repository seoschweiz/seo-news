...
CONFIGS = {
    ...
    "de": {
        ...
        "widget_title": "SEO News Schweiz",
        "widget_all": "Alle SEO News ansehen →",
    ...
    "en": {
        ...
        "widget_title": "SEO News Switzerland",
        "widget_all": "View all SEO News →",
    ...
    "fr": {
        ...
        "widget_title": "Actualités SEO Suisse",
        "widget_all": "Voir toutes les actualités SEO →",
    ...
    "it": {
        ...
        "widget_title": "Notizie SEO Svizzera",
        "widget_all": "Vedi tutte le notizie SEO →",
    ...
    "es": {
        ...
        "widget_title": "Noticias SEO Suiza",
        "widget_all": "Ver todas las noticias SEO →",
    ...
    "pt": {
        ...
        "widget_title": "Notícias SEO Suíça",
        "widget_all": "Ver todas as notícias SEO →",
...
def rss_button(language):
    ...
    return (
        f'<a class="rss-button" '
        f'href="/{language}/feed.xml">'
        f'RSS Feed</a>'
    )
...
def generate_article_page(
    ...
    page_title = optimized_title(
        config,
        article
    )

    page_h1 = optimized_h1(
        config,
        article
    )
...
def generate_widget(
    ...
    widget_title_json = json.dumps(
        config["widget_title"],
        ensure_ascii=False
    )

    widget_all_json = json.dumps(
        config["widget_all"],
        ensure_ascii=False
    )
...
var widgetTitle = {widget_title_json};

var widgetAll = {widget_all_json};
...
html += '<a href="{language_url}" target="_blank" rel="noopener" style="font-weight:bold;text-decoration:none;color:#c00000;">';

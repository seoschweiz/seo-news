...
CONFIGS = {
    ...
    "de": {
        ...
        "meta_description":
            "Aktuelle SEO News über Google, Bing, "
            "Suchmaschinenoptimierung, Google Updates, "
            "AI Search, Keywords, Backlinks und digitales Marketing.",
        ...
        "article_intro":
            "Diese Meldung wurde über unseren automatischen "
            "SEO-News-Monitor gefunden.",
    ...
    "en": {
        ...
        "subtitle":
            "Google Search, SEO, algorithm updates, "
        ...
        "meta_description":
            "Latest SEO news about Google Search, algorithm updates, "
            "AI Search, search engine optimization, keywords, "
            "backlinks and digital marketing.",
        ...
        "feed_description":
            "Latest English-language SEO news about Google Search, "
            "SEO, algorithms and AI Search.",

        "article_intro":
            "This story was discovered by our automated SEO news monitor.",

        "source_label": "Source",

        "back":
            "← Back to latest SEO news"
    },
    ...
    "fr": {
        ...
        "empty_text":
            "Une nouvelle recherche sera effectuée lors "
            "de la prochaine mise à jour automatique.",

        "feed_title":
            "Actualités SEO Français",

        "feed_description":
            "Actualités SEO en français sur Google, "
            "le référencement, les algorithmes et la recherche IA.",

        "article_intro":
            "Cette actualité a été détectée par notre système "
            "automatique de veille SEO.",

        "source_label": "Source",

        "back":
            "← Retour aux actualités SEO"
    },
    ...
    "it": {
        ...
        "subtitle":
            ...
            "aggiornamenti degli algoritmi, AI Search "
        ...
        "empty":
            "Nessuna notizia SEO recente trovata",

        "empty_text":
            "Il sistema effettuerà una nuova ricerca "
            "al prossimo aggiornamento automatico.",

        "feed_title":
            "Notizie SEO Italiano",

        "feed_description":
            "Notizie SEO in italiano su Google, "
            "ottimizzazione, algoritmi e AI Search.",

        "article_intro":
            "Questa notizia è stata individuata dal nostro "
            "sistema automatico di monitoraggio SEO.",

        "source_label": "Fonte",

        "back":
            "← Torna alle notizie SEO"
    },
    ...
    "es": {
        ...
        "meta_description":
            ...
            "actualizaciones de algoritmos, búsqueda con IA, "
            "palabras clave, backlinks y marketing digital.",
        ...
        "empty_text":
            "El sistema volverá a buscar durante "
        ...
        "feed_description":
            "Noticias SEO en español sobre Google, "
            "posicionamiento, algoritmos y búsqueda con IA.",

        "article_intro":
            "Esta noticia fue detectada por nuestro sistema "
            "automático de seguimiento SEO.",
    ...
    "pt": {
        ...
        "subtitle":
            "Google, otimização para motores de pesquisa, "
            "atualizações de algoritmos, pesquisa com IA "
            "e marketing digital.",
        ...
        "meta_description":
            "Últimas notícias SEO sobre Google, otimização para "
            "motores de pesquisa, atualizações de algoritmos, "
            "pesquisa com IA, palavras-chave, backlinks "
            "e marketing digital.",
        ...
        "empty_text":
            "O sistema irá pesquisar novamente durante "
        ...
        "feed_description":
            "Notícias SEO em português sobre Google, "
            "otimização, algoritmos e pesquisa com IA.",

        "article_intro":
            "Esta notícia foi encontrada pelo nosso sistema "
            "automático de monitorização SEO.",
